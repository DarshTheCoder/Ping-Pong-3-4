...
right_wristX=0;
right_wristY=0;
keyScore_rightWrist=0;
function setup()
{
  canvas=createCanvas(420,600);
...
function draw(){
  image(video,0,0,420,600);
  if(keyScore_rightWrist > 0.2)
  {
    fill("#FF000");
    stroke("#FF000");
...
if(results.length > 0)
{
  ...
  keyScore_rightWrist=results[0].pose.keypoints[10].score;
